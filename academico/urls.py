...
urlpatterns = [
    ...
    path('fichas/<int:pk>/cambiar-estado/', views.cambiar_estado_ficha, name='ficha_cambiar_estado'),
    path('fichas/<int:pk>/eliminar/', views.eliminar_ficha, name='ficha_eliminar'),
    path('fichas/<int:pk>/agregar-aprendiz-rapido/', views.agregar_aprendiz_rapido, name='ficha_agregar_aprendiz_rapido'),
