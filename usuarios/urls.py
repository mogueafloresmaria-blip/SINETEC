...
urlpatterns = [
    ...
    path('pensiones/', views.caja_pensiones, name='caja_pensiones'),
    path('pensiones/nuevo/', views.nuevo_cobro, name='nuevo_cobro'),
    ...
    path('transporte/', views.transporte_escolar, name='transporte_escolar'),
    path('transporte/nueva/', views.nueva_ruta_transporte, name='nueva_ruta_transporte'),
    ...
    path('calificaciones/ficha/<int:ficha_id>/eliminar/', views.eliminar_registro_notas, name='eliminar_registro_notas'),
    ...
    path('innovacion/<int:pk>/', views.innovacion_proyecto_detalle, name='innovacion_proyecto_detalle'),
